...
class ImportSpecification(AAZCommand):
    ...
    :example: Import specification from file example
        az apic api definition import-specification -g api-center-test -n contosoeuap --api-id echo-ap --version-id 2023-08-01 --definition-id openapi --format "inline" --value '@petstore.json'
    """
