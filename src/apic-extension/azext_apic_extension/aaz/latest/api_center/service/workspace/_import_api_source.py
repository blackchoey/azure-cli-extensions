...
@register_command(
    "api-center service workspace import-api-source",
    is_preview=True,
)
class ImportApiSource(AAZCommand):
    ...
    class WorkspacesImportApiSource(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            _ImportApiSourceHelper._build_schema_operation_status_result_read(cls._schema_on_200)

            return cls._schema_on_200


class _ImportApiSourceHelper:
    """Helper class for ImportApiSource"""
